...
You are tasked with generating a fully self-contained `design.prompt.md` file for the 4DC project. Use the contents of all files in the `/templates/design` folder (including prompt.md, persona.md, process.md, interaction.md, output.md) as source material.
